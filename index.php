   ...
   <header id="header"><!--header-->
				...
				<div>
					<div class="col-sm-6" >
						<div class="logo pull-left" >
                            ...
                            <img src="images/logo.png" width="150" height="150"></a>
						</div>
					</div>
					<div class="col-sm-6">
							...
							<ul class="nav navbar-nav collapse navbar-collapse">
								...
								<li class="dropdown"><a href="?page=menu">Menu<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
                                        <li><a href="?page=bun">Bun</a></li>
										<li><a href="?page=drink">Drink</a></li> 
										<li><a href="?page=wholecake">Whole Cake</a></li>
                                        <li><a href="?page=newproduct">Products coming soon</a></li> 
                                    </ul>
                                </li> 
    ...
    <?php
        if(isset($_GET['page']))
        {
            ...
            elseif($page=="bun")
            {
                include_once("Bun.php");
            }
            elseif($page=="drink")
            {
                include_once("Drink.php");
            }
            elseif($page=="wholecake")
            {
                include_once("WholeCake.php");
            }
            elseif($page=="cart")
            {
                        ...
                        <div class="row">
                            <div class="col-md-3 col-sm-6">
                                <div class="footer-about-us">
                                    <h2>Bread<span>talk</span></h2>
                                    <p>Founded in 2000, the BreadTalk Group has rapidly expanded to become a distinctive household brand owner that has established its mark on the world stage with its bakery, restaurant and food atrium footprints. Today, with close to 900 outlets in 15 international markets, the BreadTalk Group produces culinary magic for everyday recipes that you savour, uniting people with good taste around the world.</p>
                ...
                <div class="footer-bottom-area">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-8">
                                <div class="copyright">
                                    <p>&copy;Copyright © 2020  BreadTalk Group Pte Ltd. All Rights Reserved. Design by Kevin</p>
                                </div>
                            </div>
